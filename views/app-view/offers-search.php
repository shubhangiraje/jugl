                ...
                <div class="searches-result-box" scroll-load="offerSearchCtrl.loadMore" scroll-load-visible="0.7" scroll-load-has-more="results.hasMore">
                    <div class="sort-content clearfix">
						...
						<div class="sort-box country">
                            <label><?=Yii::t('app', 'Artikelstandort');?>:</label>
                    ...
                    <div ng-repeat="item in results.items" class="found-item-box item-offers" ng-class="{'advertising_offer_search': item.advertising_type}">
						<div class="advertising_banner" ng-if="item.advertising_display_name && item.advertising_type == 'BANNER' && item.id && item.user_bonus && item.link && item.banner">
							<div id="advertising-{{item.id}}" a-data-id="{{item.id}}" a-data-user-bonus="{{item.user_bonus}}" ng-click="offerSearchCtrl.setAdvertising({{item.id}}, {{item.user_bonus}}, {{item.click_interval}}, {{item.popup_interval}})">
                        ...
                        <div class="found-offers-box" ng-if="!item.advertising_type">
                            ...
                            <div class="found-title" ng-if="!item.advertising_type">
                                <h2><a ui-sref="offers.details({id:item.id})">{{::item.title}}</a></h2>
                            </div>
                            <ul class="found-category" ng-if="!item.advertising_type">
                            ...
                            <div class="found-offers-info-wrap clearfix" ng-if="!item.advertising_type">
