...
<div class="content" ng-controller="VotesInfoPopupCtrl as votesInfoPopupCtrl">
    <div scroll-pane scroll-config="{contentWidth: '0', autoReinitialise: true, showArrows: false}" auto-height-popup id="votes-view-scroll">
        <div scroll-load="votesInfoPopupCtrl.loadMore" scroll-load-visible="0.7" scroll-load-has-more="log.hasMore" class="votes-view-box clearfix">
            <div ng-repeat="item in log.items" class="vote-user-box">
                <div class="vote-user">
                    <div ng-click="votesInfoPopupCtrl.goProfile(item.user.id)" class="pointer user-avatar-small">
                    ...
                    <div ng-if="item.vote<0" class="vote negative"></div>
                    <div ng-if="item.vote>0" class="vote positive"></div>
                </div>
            </div>
        </div>
    </div>
