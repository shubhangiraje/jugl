<div id="friends-page">
    <div class="container">
        <h1><?=Yii::t('app','Neu im Netzwerk')?></h1>
        ...
        <div class="account-box">
            <div class="account-friends-list clearfix" scroll-load="networkMembersCtrl.loadMore" scroll-load-visible="0.7" scroll-load-has-more="networkMembers.hasMore" ng-class="{empty:networkMembers.users.length == 0}">
                <div class="account-friends-element" ng-repeat="user in networkMembers.users">
                    <?php
                        $myFriendsPage = true;
