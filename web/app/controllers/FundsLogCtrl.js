app.controller('FundsLogCtrl', function ($scope, fundsLogData, jsonDataPromise,$rootScope) {

    angular.extend($scope, fundsLogData);
    ...
    $scope.$watch('fundsLogCtrl.filters',function(new_value, old_value) {
    ...
    this.getFundsLog = function(callback) {
        ...
        jsonDataPromise('/api-funds-log/log',{
