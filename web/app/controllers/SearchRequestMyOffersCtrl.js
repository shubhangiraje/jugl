app.controller('SearchRequestMyOffersCtrl', function ($scope, searchRequestMyOffersData, $timeout, $state, $stateParams, jsonDataPromise) {

    var self=this;

    angular.extend($scope, searchRequestMyOffersData);
    ...
    this.getResults = function(callback) {
        ...
        jsonDataPromise('/api-search-request-my-offer/list',{filter:$scope.filter,pageNum:$scope.state.pageNum})
            .then(function (data) {
