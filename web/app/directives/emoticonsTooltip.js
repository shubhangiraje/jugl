app.directive('emoticonsTooltip', function($document, $rootScope) {
    return {
        restrict: 'A',
        scope: {
            emoticonsList: '=',
        ...
        link: function(scope, element, $attrs) {
            ...
            if($attrs.emoticonForum) {
                var parentForumForm = $(element).closest('.trollbox-form');
                $textarea = parentForumForm.find('textarea');
            }

            scope.emoticonsList.map(function(emoticon) {
