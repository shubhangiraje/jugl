...
/**
 * This is the model class for table "search_request_offer_details_file".
 *
 ...
 * @property File $file
 */
class SearchRequestOfferDetailsFile extends \app\components\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'search_request_offer_details_file';
    }
