...
class ExtApiUserTeamRequestController extends \app\components\ExtApiController {
    ...
    public function actionAccept() {
        ...
        if ($userTeamRequest->type==\app\models\UserTeamRequest::TYPE_REFERRAL_TO_PARENT) {
            ...
            $userTeamRequest->userEvent->text=preg_replace('%\[userTeamRequestAccept.*\[/userTeamRequestDecline\]%',Yii::t('app','Du hast die Anfrage angenommen'),$userTeamRequest->userEvent->text);
            ...
            foreach($userTeamRequests as $utr) {
                $utr->userEvent->text=preg_replace('%\[userTeamRequestAccept.*\[/userTeamRequestDecline\]%',Yii::t('app','Andere Nutzer hast anfrage angenommen'),$userTeamRequest->userEvent->text);
                $utr->userEvent->save();
                $utr->delete();
            }
    ...
    public function actionDecline() {
        ...
        if ($userTeamRequest->type==\app\models\UserTeamRequest::TYPE_REFERRAL_TO_PARENT) {
            $userTeamRequest->userEvent->text=preg_replace('%\[userTeamRequestAccept.*\[/userTeamRequestDecline\]%',Yii::t('app','Du hast die Anfrage abgelehnt'),$userTeamRequest->userEvent->text);
            $userTeamRequest->userEvent->save();
            $userTeamRequest->delete();
