 ...
 */
class AdminSearchRequestOfferController extends AdminController
{
    ...
    public function actionDelete($id)
    {
        ...
        $model->status=SearchRequestOffer::STATUS_DELETED;
        $model->save();
    ...
    {
        if (($model = SearchRequestOffer::find()->where(['id'=>$id])->one()) !== null) {
            return $model;
        } else {
