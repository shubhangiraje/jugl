...
class ExtApiTeamChangeUserSearchController extends \app\components\ExtApiController {
    ...
    public function getUsers($params) {
        ...
        $returnResults=trim($sex.$name.$zipcity.$ageFrom.$ageTo.$single)!='';
        ...
        if ($returnResults) {
            ...
            foreach($users as $user) {
                $userData=$user->getShortData(['rating','team_rating']);
