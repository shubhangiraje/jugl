...
class ApiInterestsController extends \app\components\ApiController {
    ...
    private function getInterestsLevelData($parent_id = NULL, $type = NULL) {
        ...
        foreach ($interests as $item) {
            $thumb = $item->file->link ? $thumb = $item->file->getThumbUrl('interest') : $thumb = \app\components\Thumb::createUrl('/static/images/account/default_interest.png','interest');
