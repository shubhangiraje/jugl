...
class ExtApiDashboardNewController extends \app\components\ExtApiController  {
...
*/
    ...
    public function actionGetTrollbox($country_ids=false) {
	   ...
	   return [
            'items'=>\app\models\TrollboxMessage::getHistory(null,null,3,$countries,true),
			'countryArrayTrollbox'=>$this->getCountryListTrollbox(),
			'dashboardForumText'=>\app\models\Setting::getDashboardForumText(Country::getCountryLanguage($countries[0])),
